...
public class CodeAction extends HttpServlet {
	...
	// 验证码字体
	private Font[] codeFont = { new Font("Times New Roman", Font.PLAIN, 24),
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		session.removeAttribute("com.servlet.codenumber");
		session.setAttribute("com.servlet.codenumber", codeNumbers);
		// 重设字符串
		codeNumbers = "";
	...
	public void drawCode(Graphics graphics, int i) {
		...
		//绘制验证码到图片X、Y（每个字体x每次步进14的倍数，y不变，大小6*6）
		graphics.drawString(number, 9 + i * 14, 23);
